...
class IndexController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $request->out_money = UserOperation::where('operation_type_id',12)->where('recipient_id',Auth::user()->user_id)->sum('money');
    ...
    public function profitRobotAfterMonth()
    {
        ...
        foreach ($users as $key => $item){
            ...
            if($months > 0 && $user_status != null && $user_status->user_month_activation_money > 0 && $user->user_money >= $user_status->user_month_activation_money){
                $user->user_money = $user->user_money - $user_status->user_month_activation_money;
                ...
                $operation->money = -1 * $user_status->user_month_activation_money;
                ...
                while ($user_id != null) {
                    ...
                    $money = $user_status->user_month_activation_money / 10;
                ...
                $operation->money = $user_status->user_month_activation_money - $send_money;
                $operation->operation_id = 1;
                $operation->operation_type_id = 14;
                ...
                $company->user_money = $company->user_money + $user_status->user_month_activation_money - $send_money;
                $company->save();
            }
            elseif($months > 0) {
                $user->is_activated = 0;
    ...
    public function robotBinarProfit()
    {
        ...
        foreach ($users as $key => $item) {
            ...
            $operation->operation_comment = null;
            $operation->save();
