    ...
    public function programsDetail($id) {
        ...
        $programs = collect([
                [
                    ...
                    'imgSrc'=> "baspana-plus.jpg",
                    'body'=> "BASPANA PLUS - собственное жилье в рассрочку с первоначальным взносом",
                    'about_program' => 'Программа с первоначальным взносом для приобретения жилья в рассрочку',
                    'rating' => 3.5,
                    'like' => 2,
                    'comment' => 2093,
                    'category_id'=> 1,
                ...
                [
                    ...
                    'imgSrc'=> "tulpar-plus.jpg",
                    'body'=> "TULPAR PLUS - автомобиль мечты в рассрочку с первоначальным взносом",
                    'about_program' => 'Программа с первоначальным взносом для приобретения автомобиля в рассрочку',
                    'entrance_fee' => '240 000 тг',
                    'rating' => 3.5,
                    'like' => 2,
                    'comment' => 2093,
                ...
                [
                    ...
                    'imgSrc'=> "baspana.jpg",
                    'body'=> "BASPANA - жилье для большой семьи в рассрочку",
                    'about_program' => 'Программа с накопительно-паевым взносом для приобретения жилья в рассрочку',
                    'entrance_fee' => '240 000 тг',
                    'rating' => 3.5,
                    'like' => 2,
                    'comment' => 2093,
                ...
                [
                    ...
                    'imgSrc'=> "tulpar.jpg",
                    'body'=> "TULPAR - автомобиль для всей семьи в рассрочку",
                    'about_program' => 'Программа с накопительно-паевым взносом для приобретения автомобиля в рассрочку',
                    'entrance_fee' => '240 000 тг',
                    'rating' => 3.5,
                    'like' => 2,
                    'comment' => 2093,
                ...
                [
                    ...
                    'imgSrc'=> "jastar.jpg",
                    'body'=> "JASTAR - жилье для молодежи в рассрочку",
                    'about_program' => 'Программа с накопительно-паевым взносом для приобретения жилья в рассрочку для молодежи',
                ...
                [
                    ...
                    'imgSrc'=> "jas-otau.jpg",
                    'body'=> "JAS OTAU - жилье для молодых семей в рассрочку",
                    'about_program' => 'Программа с накопительно-паевым взносом для приобретения жилья в рассрочку для молодых семей',
                ...
                [
                    ...
                    'imgSrc'=> "qoldau.jpg",
                    'body'=> "QOLDAU - жилье медработников и учителей в рассрочку",
                    'about_program' => 'Программа с накопительно-паевым взносом для приобретения жилья в рассрочку для работников сферы медицины и образования',
                    'entrance_fee' => '120 000 тг',
                    'rating' => 3.5,
                    'like' => 2,
                    'comment' => 2093,
