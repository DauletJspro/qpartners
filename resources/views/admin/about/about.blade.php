      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title box-title-first">
            <a href="/admin/about" class="menu-tab @if(!isset($request->active) || $request->active == '1') active-page @endif">Активные страницы</a>
          </h3>
          <h3 class="box-title box-title-second" >
            <a href="/admin/about?active=0" class="menu-tab @if($request->active == '0') active-page @endif">Неактивные страницы</a>
          </h3>
            ...
            <tbody>
                  ...
                  @foreach($row as $key => $val)
                     ...
                     <tr>
                        <td> {{ $key + 1 }}</td>
                        <td>
                            <a target="_blank" style="text-decoration: underline" href="/{{\App\Http\Helpers::getTranslatedSlugRu($val->about_name_ru)}}-u{{$val->about_id}}">
                                {{ $val['about_name_ru']}}
                            </a>
                        </td>
                        <td>
