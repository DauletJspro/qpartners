                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            ...
                            <button class="btn btn-primary box-add-btn" onclick="copyLink()" style="margin-top: 10px">
                                Скопировать
                            </button>
                            <div class="shareSprite">
                                <h4>Или Вы можете поделиться со своими друзьями в социальной сети</h4>
                                <div class="share42init" data-image="{{URL('/').'/default.png'}}" data-url="{{$url}}"
                                     data-description="Qpartners - это Казахстанская компания, которая производит и распространяет серебряные изделия высшей пробы по доступным ценам."></div>
                            </div>
                        </div>
                    </div>
                </div>
