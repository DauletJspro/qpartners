    ...
    <div class="row statistics-profile">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    <h3>{{round($row->home_profit_today,2)}}<sup style="font-size: 20px">$</sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                <div class="inner">
                    <h3>{{round($row->home_profit_last_week,2)}}<sup style="font-size: 20px">$</sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                <div class="inner">
                    <h3>{{round($row->home_profit_last_month,2)}}<sup style="font-size: 20px">$</sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                <div class="inner">
                    <h3>{{round($row->home_profit_all,2)}}<sup style="font-size: 20px">$</sup></h3>
