    ...
    <div class="row statistics-profile">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-purple">
                <div class="inner">
                    <h3>{{round($row->shareholder_average_mount,2)}}<sup style="font-size: 20px">$</sup></h3>
                    <h2 style="margin-top: 0px">{{round($row->currency->money * $row->shareholder_average_mount,2)}}<sup style="font-size: 20px">ТГ</sup></h2>
                    <p>Средний чек</p>
                </div>
                <div class="icon">
