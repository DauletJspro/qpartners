<ul class="sidebar-menu">
    ...
    <li class="header" style="text-align: center; padding:5px 25px 5px">
        <p style="color:#009551;margin:0px;">ЛО: <span style="font-weight: bold">{{$lo_profit}}$</span> ЛКО: <span
                    style="font-weight: bold">{{Auth::user()->left_child_profit}}$</span> ПКО: <span
                    style="font-weight: bold">{{Auth::user()->right_child_profit}}$</span></p>
        <p style="color:#009551;margin:0px;">КВО: <span style="font-weight: bold">{{Auth::user()->qualification_profit}}
                $</span></p>
    </li>
