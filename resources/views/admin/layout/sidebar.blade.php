<ul class="sidebar-menu">
    @if(Auth::user()->role_id != 9)
        ...
        @if(!\App\Models\Users::hasRole(\App\Models\Users::AccountantTitle))
            ...
            <li class="header" style="padding:5px 25px 0px">
                ...
                @if(!\App\Models\Users::hasRole(\App\Models\Users::ConsumerTitle))
                    <p style="color:#009551;margin:0px;font-weight: bold; font-size: 14px;">
                        Кэшбэк: {{Auth::user()->cashback}}
                        PV
            ...
            @if(Auth::user()->is_activated && !(\App\Models\Users::hasRole(\App\Models\Users::ConsumerTitle)))
                <li class="treeview">
                    <a href="/admin/index">
        ...
        @if(Auth::user()->role_id == App\Models\Role::CONSUMER)
            ...
            @if(Auth::user()->role_id == 1)
                {{--        @if(Auth::user()->user_id != \App\Models\Users::ACCOUNTANT)--}}
                @if(!\App\Models\Users::hasRole(\App\Models\Users::hasRole(\App\Models\Users::AccountantTitle)))
                    <li class="treeview">
            ...
            @if(!\App\Models\Users::hasRole(\App\Models\Users::hasRole(\App\Models\Users::AccountantTitle))
               && !(\App\Models\Users::hasRole(\App\Models\Users::ConsumerTitle)))
                <li class="treeview">
        ...
        @if(\App\Models\Users::hasRole(\App\Models\Users::AdminTitle))
            <li class="treeview">
