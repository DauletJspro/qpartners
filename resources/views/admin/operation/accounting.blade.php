                                    ...
                                    @foreach($row->row as $key => $val)
                                        ...
                                        <tr>
                                            ...
                                            <td class="arial-font">
                                                ...
                                                <div>
                                                    <span style="font-weight: 900">ЛКО: {{ $val->left_child_profit }} $ ({{round($val->left_child_profit * \App\Models\Currency::where('currency_name','тенге')->first()->money,2)}}тг)</span>
                                                    <span style="font-weight: 900">ПКО: {{ $val->right_child_profit }} $ ({{round($val->right_child_profit * \App\Models\Currency::where('currency_name','тенге')->first()->money,2)}}тг)</span>
                                                </div>
                                            </td>
                                            <td class="arial-font">
                                                <div>
