                       ...
                       <div class="box box-primary">
                               ...
                               <form action="/admin/profile/edit" method="POST">
                                   ...
                                   <div class="box-body">
                                       ...
                                       <div class="form-group">
                                           <label>Страна</label>
                                           <select onchange="getCityListByCountry2(this)"  name="fact_country_id" data-placeholder="Выберите страну" class="form-control" data-live-search="true">
                                               @foreach($country_row as $item)
                                                   <option @if($row->country_id == $item->country_id) {{'selected'}} @endif value="{{$item->country_id}}">{{$item['country_name_ru']}}</option>
                                               @endforeach
                                       ...
                                       <div class="form-group">
                                           <select id="fact_city_id" required name="fact_city_id" data-placeholder="Выберите город" class="form-control" data-live-search="true">
                                               ...
                                               @foreach($city_row as $item)
                                                   <option @if($row->fact_city_id == $item->city_id) {{'selected'}} @endif value="{{$item->city_id}}">{{$item['city_name_ru']}}</option>
                                               @endforeach
                                           </select>
                                       </div>
                                       <div class="form-group">
