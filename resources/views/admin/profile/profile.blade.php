            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>Страна (Юр)</b> <a class="pull-right">{{$row->country_name_ru}}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Город (Юр)</b> <a class="pull-right">{{$row->city_name_ru}}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Адрес (Юр)</b> <a class="pull-right">{{$row->address}}</a>
                        </li>
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <b>Страховка </b> <a class="pull-right">@if($row->is_insurance == 1) Да @else Нет @endif</a>
                        </li>
                        <li class="list-group-item">
                            <b>Юридическая карта </b> <a class="pull-right">@if($row->is_legal_map == 1) Да @else Нет @endif</a>
                        </li>
                        <li class="list-group-item">
                            <b>Обучение </b> <a class="pull-right">@if($row->is_education == 1) Да @else Нет @endif</a>
                        </li>
                        <li class="list-group-item">
                            <b>Размер кольца </b> <a class="pull-right">{{$row->size_ring}}</a>
                        </li>
                    </ul>
        ...
        <div class="col-md-7">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li @if(!isset($_GET['tab'])) class="active" @endif>
                        <a style="font-size: 13px" href="#profit" data-toggle="tab">Доход</a>
                    </li>
                    <li><a style="font-size: 13px"  href="#packet_list" data-toggle="tab">Пакеты</a></li>
                    ...
                    @if(Auth::user()->role_id == 1)
                        ...
                        <li @if(isset($_GET['tab']) && $_GET['tab'] == 'volume') class="active" @endif>
                            <a style="font-size: 13px"  href="#volume" data-toggle="tab">Командный объем</a>
                        </li>
                    @endif
                </ul>
                <div class="tab-content" style="min-height: 400px">

                    <div class="@if(!isset($_GET['tab'])) active @endif tab-pane" id="profit">
                        @include('admin.profile.profit')
                    </div>

                    <div class="tab-pane" id="packet_list">
