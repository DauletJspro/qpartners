    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div>
                    <div class="box-body">
                        <a href="/admin/homes/create "><button type="button" class="btn btn-primary">Создать группу</button></a>
                        <a href="/admin/homes/clients"><button type="button" class="btn btn-primary ">Добавить пользователя</button></a>
                                        ...
                                        @foreach($getGroup as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td class="arial-font">
                                                    <a class="main-label"
                                                       target=""><p
                                                                class="">@if($val->program_id == 4) Баспана + @endif</p>
                                                    </a>
                                                </td>
                                                <td class="arial-font">
                                                    <a class="main-label" href="/admin/homess/{{$val->id}}"
                                                       target="_blank"><p
