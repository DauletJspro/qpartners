    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div>
                    <div class="box-body">
                        <a href="/admin/home/create "><button type="button" class="btn btn-primary">Создать группу</button></a>
                        <a href="/admin/client/share/holder/home"><button type="button" class="btn btn-primary ">Добавить пользователя</button></a>
                                    ...
                                    <table id="news_datatable" class="table table-bordered table-striped table-css">
                                        ...
                                        @foreach($getGroup as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td class="arial-font">
                                                    <a class="main-label" href="/admin/home/{{$val->id}}"
                                                       target="_blank"><p
