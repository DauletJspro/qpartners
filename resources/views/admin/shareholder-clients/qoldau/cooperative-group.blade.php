    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div>
                        <div class="box-body">
                            <a href="/admin/qoldau/create"><button type="button" class="btn btn-primary">Создать группу</button></a>
                            <a href="/admin/qoldau/clients"><button type="button" class="btn btn-primary ">Добавить пользователя</button></a>
                                            ...
                                            @foreach($getGroup as $key => $val)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="arial-font">
                                                        <a class="main-label"
                                                           target=""><p
                                                                    class="">@if($val->program_id == 5) Qoldau @endif</p>
                                                        </a>
                                                    </td>
                                                    <td class="arial-font">
                                                        <a class="main-label" href="/admin/qoldau/{{$val->id}}"
                                                           target="_blank"><p
