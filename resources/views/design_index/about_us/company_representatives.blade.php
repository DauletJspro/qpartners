...
@section('content')
    <main id="mt-main">
        ...
        >
            <p style="font-family: Montserrat;color: white; font-weight: 600; font-size: 40px; text-align: center; text-transform: uppercase;text-shadow: 1px 1px 1px black;">Представители</p>
