    ...
    <main id="mt-main">
        ...
        <section class="container mt-contact-banner wow fadeInUp" data-wow-delay="0.4s"  style=" background-size: 100% 100%;
            ...
            background-repeat: no-repeat;
             background: red;">
            <p style="font-family: Montserrat;color: white;font-weight: 600; font-size: 40px; text-align: center; text-transform: uppercase;text-shadow: 1px 1px 1px black;">о Gap Card</p>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="" style="color: black; font-size: 18px; margin-bottom: 50px; font-family: Montserrat;">
                            <p style="font-weight: 600; font-size: 24px">Что такое GAP CARD?</p>
                            <div class="container">
