            ...
            <div class="container" style="margin-top: 0;padding:50px 10px; color:#000;">
                <div class="row row-1 text-center">
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xs-12" style="margin-bottom:15px; text-align: left;">
                        ...
                        <p ><span style="font-weight:bold;">Для этого Вам необходимо выполнить условия, закрыв 4 статуса течений 6 месяцев:</span></p>
                        <div class="col-sm-12">
                        ...
                        <p>Если Вы не успеете выполнить 4 условия в течений 6 месяцев, Вы получите автомобиль не в подарок, а в рассрочку.</p>
                        <p><span style="font-weight:bold;">Не упустите свой шанс обладателем своего автомобиля!</span></p>
