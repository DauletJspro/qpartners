                        ...
                        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xs-12" style="margin-bottom:15px; text-align: left;">
                            <div class="packet-body">
                                <div class="my-img-circle text-center" style="padding: 0;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/home-activ.png" width='790' height='380' alt="">
                                    <div class="holder" style="position: absolute;top: 9%;text-align:left;right: 54%;">
							        	<div class="texts" style="font-family: Akrobat;color: #000;position: absolute;left: 10%;top: 32%;width: 370px;font-weight: bold;">
							        		<span class="mb-0" style="font-size:44px;font-weight:bold;color:#ffd700;line-height: 1;">СВОЙ ДОМ ЗА СЧЕТ КОМПАНИИ</span>
                                            <p class="mb-0" style="font-size:20px;font-weight:bold;color:#fff;">Выполни условия за 12 месяцев и получи ДОМ ЗА СЧЕТ компании!</p>
                                       </div>
							        </div>
                                </div>
                            </div>
                            
                            <h4 style="font-size: 30px;font-weight: bold; text-align:center;">ЖИЛЬЁ ПО ПРОГРАММЕ "ACTIV"</h4>
                       
                            <p><span style="font-weight:bold;">Мечтаете о собственном доме? Хотите мы ее Вам подарим?</span></p>
                            <p>Тогда программа <span style="font-weight:bold;"> "ACTIV"</span>для Вас!</p>
                            <p>Став участником<span style="font-weight:bold;"> Социальной программы GAP и получив статус Партнер Qyran Partners Club</span> Вы сможете приобрести жилье за счет компании на сумму  9 000 000 KZT</p>
                            <p ><span style="font-weight:bold;">Для этого Вам необходимо выполнить условия, закрыв 5 статусов течений 12 месяцев:</span></p>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="text-center" style="padding: 0 60px;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/Жилье Актив3.png" alt="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="text-center" style="padding: 0 60px;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/Жилье Актив4.png" alt="">
                                </div>
                            </div>

                            
                            <p style="color:red;font-weight:bold;">Важно!</p>
                            <p>При выполнении <span style="font-weight:bold;"> 5 условий за 12 месяцев </span>Вы не сможете получить жилье за счет компании, но Вы сможете получить рассрочку с момента внесения первонального взноса.</p>
