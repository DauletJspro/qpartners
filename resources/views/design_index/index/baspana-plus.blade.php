                        ...
                        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xs-12" style="margin-bottom:15px; text-align: left;">
                            <div class="packet-body">
                                <div class="my-img-circle text-center" style="padding: 0;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/b-4.png" width='790' height='380' alt="">
                                    <div class="holder" style="position: absolute;top: 2%;text-align:left;left: 10%;">
							        	<div class="texts" style="font-family: Akrobat;color: #000;position: absolute;left: 10%;top: 32%;width: 370px;font-weight: bold;">
							        		<span class="mb-0" style="font-size:44px;font-weight:bold;color:#ffd700;line-height: 1;">ДОМ ДЛЯ ВСЕЙ СЕМЬИ</span>
                                            <p class="mb-0" style="font-size:20px;font-weight:bold;">Внеси первоначальный взнос и получи рассрочку на жильё!</p>
                                       </div>
							        </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="text-center" style="padding: 0 60px;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/Баспана плюс.png" alt="">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="text-center" style="padding: 0 60px;">
                                    <img class="rounded-circle " src="/new_design/images/Partner/Баспана плюс1.png" alt="">
                                </div>
                            </div>
                            ...
                            <p><span style="font-weight:bold;">Первоначальный взнос: 30% или 50% </span></p>
                            <p><span style="font-weight:bold;">Погашение: 75 000 KZT </span></p>
