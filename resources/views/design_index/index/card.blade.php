            ...
            <div class="container">
                <div class="gallery js-flickity"
                    ...
                    <div class="gallery-cell">
                        <a href="product-detail.html"><img src="new_design/images/products/1.jpg"
                                                           alt="image description"></a>
                    </div>
                    <div class="gallery-cell">
                        <a href="product-detail.html"><img src="new_design/images/products/2.jpg"
                                                           alt="image description"></a>
                    </div>
                    <div class="gallery-cell">
                        <a href="product-detail.html"><img src="new_design/images/products/3.jpg"
                                                           alt="image description"></a>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="nav nav-list">
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu1"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">РАЗВЛЕЧЕНИЯ <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu1">
                                        <li>
                                            <a class="accordion-heading active" data-filter="activeweeknd"
                                               data-toggle="collapse" data-target="#submenu1">Активный отдых
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-filter="park" data-toggle="collapse"
                                               data-target="#submenu1">Парки развлечений
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-filter="practice" data-toggle="collapse"
                                               data-target="#submenu1">
                                                Развлечения для детей
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-filter="pown" data-toggle="collapse"
                                               data-target="#submenu1">Сауны и бани
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-filter="quest" data-toggle="collapse"
                                               data-target="#submenu1">Квесты, игровые клубы
                                                <span class="pull-right"></span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu2"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">ЕДА <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu2">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu2">Рестораны,
                                                кафе и бары
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu3"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">ЗДОРОВЬЕ <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu3">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu3">МРТ
                                                и КТ
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu3">Прием
                                                к врачу
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu3">Хирургия,
                                                пластика
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu3">Соляные
                                                пещеры
                                                <span class="pull-right"></span></a>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu4"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">КРАСОТА <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>
                                    ...
                                    <ul class="nav nav-list collapse" id="submenu4">
                                        ...
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu4">Уход
                                                за ногтями
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu5"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">СПОРТ <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu5">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu5">Прокат
                                                и аренда
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu5">Тренажерный
                                                зал
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu5">Спортивные
                                                секции
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu6"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">ТУРИЗМ, ОТЕЛИ <span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu6">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu6">Гостиницы,
                                                отели
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu6">Зоны
                                                отдыха
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">УСЛУГИ<span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu7">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7">Для
                                                взрослых
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7">Обучающие
                                                курсы
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7">Развивающие
                                                курсы для детей
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7">Языковые
                                                курсы
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu7">Фото
                                                и видео
                                                <span class="pull-right"></span>
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a class="accordion-heading" data-toggle="collapse" data-target="#submenu8"
                                       style="font-weight: bold;">
                                        <span class="nav-header-primary">ТОВАРЫ<span class="pull-right"><b
                                                        class="caret"></b></span></span>
                                    </a>

                                    <ul class="nav nav-list collapse" id="submenu8">
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu8">Цветы
                                                и подарки
                                                <span class="pull-right"></span></a>
                                        </li>
                                        <li>
                                            <a class="accordion-heading" data-toggle="collapse" data-target="#submenu8">Одежда
                                                и аксессуары
                                                <span class="pull-right"></span></a>
                                        </li>
                                    </ul>
                        ...
                        <li>
                            ...
                            <div class="mt-product1 portfolio__col" data-cat="activeweeknd" style="position: relative;">
                                    ...
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="product-detail.html"><img
                                                        src="new_design/images/products/img11.jpg"
                                                        alt="image description"></a>
                                            <span class="caption">
                                ...
                                <div class="txt">
                                    ...
                                    <span style="float: right;"> <i class="fa fa-eye"
                                                                    aria-hidden="true"> </i> 244 </span>
                                    ...
                                    <a class="d-flex align-items-end v-pod"
                                       href="product-detail.html"><span>Подробнее</span></a>
                                </div>
                                <br>
                            ...
                            <div class="mt-product1 portfolio__col" data-cat="park">
                                <div class="box">
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="product-detail.html"><img
                                                        src="new_design/images/products/img12.jpg"
                                                        alt="image description"></a>
                                            <span class="caption">
                                ...
                                <div class="txt">
                                    <strong class="title"><a href="product-detail.html">Парк развлечений
                                            Evrikum</a></strong>
                                    <span style="float: right;"> <i class="fa fa-eye"
                                                                    aria-hidden="true"> </i> 244 </span>
                            ...
                            <div class="mt-product1 portfolio__col" data-cat="practice">
                                <div class="box">
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="product-detail.html"><img
                                                        src="new_design/images/products/img13.jpg"
                                                        alt="image description"></a>
                                            <span class="caption">
														<span class="best-price">Скидка 40%</span>
													</span>
                                ...
                                <div class="txt">
                                    <strong class="title"><a href="product-detail.html">Аквапарк Hawaii и
                                            Miami</a></strong>
                                    <span style="float: right;"> <i class="fa fa-eye"
                                                                    aria-hidden="true"> </i> 244 </span>
                            ...
                            <div class="mt-product1 portfolio__col" data-cat="pown">
                                <div class="box">
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="product-detail.html"><img
                                                        src="new_design/images/products/img14.jpg"
                                                        alt="image description"></a>
                                            <span class="caption">
                                ...
                                <div class="txt">
                                    <strong class="title"><a href="product-detail.html">Горный комплекс
                                            «Сункар»</a></strong>
                                    <span style="float: right;"> <i class="fa fa-eye"
                                                                    aria-hidden="true"> </i> 244 </span>
                            ...
                            <div class="mt-product1 portfolio__col" data-cat="quest">
                                <div class="box">
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="product-detail.html"><img
                                                        src="new_design/images/products/img15.jpg"
                                                        alt="image description"></a>
                                            <span class="caption">
