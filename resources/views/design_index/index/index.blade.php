...
{{--                    </div>--}}
                    ...
                    <div class="mt-patners wow fadeInUp" data-wow-delay="0.4s" style="margin-top: 50px">
                        ...
                        <div class="container" style="display: flex; flex-wrap: wrap; justify-content: space-between;font-weight: 600; height: 24px; width: 100%; font-family: adineuePROKZ-bold; font-size: 18px; margin-top: 50px">
