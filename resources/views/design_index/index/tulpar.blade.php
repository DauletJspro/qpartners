            ...
            <div class="container" style="margin-top: 0;padding:50px 10px; color:#000;">
                <div class="row row-1 text-center">
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xs-12" style="margin-bottom:15px; text-align: left;">
                            ...
                            <div class="my-img-circle text-center" style="padding: 0;">
                                ...
                                <div class="holder" style="position: absolute;top: 2%;text-align:left;left: 10%;">
                                    <div class="texts" style="font-family: Akrobat;color: #000;position: absolute;left: 10%;top: 32%;width: 370px;font-weight: bold;">
                                        <span class="mb-0" style="font-size:44px;font-weight:bold;color:#ffd700;line-height: 1;">СВОЙ АВТОМОБИЛЬ ЗА 6 МЕСЯЦЕВ</span>
                                        <p class="mb-0" style="font-size:20px;font-weight:bold;">Внеси паевые взносы ежемесячно и получи рассрочку на авто!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p><span style="font-weight:bold;">Планируете купить автомобиль в кредит? Не спешите, рассрочка лучшее решение!</span></p>
                        <p>По программе<span style="font-weight:bold;"> "TULPAR"</span> Вы можете получить рассрочку от 6 месяцев с момента вступления в программу.</p>
                        ...
                        <div class="col-sm-12">
                            <div class="text-center" style="padding: 0 60px;">
                                <img class="rounded-circle " src="/new_design/images/Partner/Авто Тулпар1.png" alt="">
                            </div>
                        </div>
                        <p><span style="font-weight:bold;">После внесения Вступительного и Паевые взноса Вы получите одобрение на получение займа на сумму до<span style="font-weight:bold;"> 9 000 000 согласно программе "TULPAR".</p>
                        ...
                        <div class="col-sm-12">
                            <div class="text-center" style="padding: 0 60px;">
                                <img class="rounded-circle " src="/new_design/images/Partner/Авто Тулпар2.png" alt="">
                            </div>
                        </div>
                        <p style="color:red;font-weight:bold;">Важно!</p>
                        <p>Займ Вы получите <span style="font-weight:bold;"> через 6 месяцев </span>после окончания периода паевых взносов.</p>
                        <p style="color:red;font-weight:bold;">Кратко о программе "TULPAR"</p>
                        <p><span style="font-weight:bold;">Сумма рассрочки: от 3 000 000 KZT </span></p>
                        <p><span style="font-weight:bold;">Срок рассрочки: до 60 месяцев </span></p>
                        <p><span style="font-weight:bold;">Срок получения займа: через 6 месяцев (паевые взносы)</span></p>
                        <p><span style="font-weight:bold;">Вступительный взнос: 240 000 KZT </span></p>
                        <p><span style="font-weight:bold;">Паевый взнос: 50 000 KZT * 6 месяцев = 300 000 KZT</span></p>
                        <p><span style="font-weight:bold;">Погашение: 50 000 KZT * 54 месяцев = 2 700 000 KZT</span></p>

                        <p><span style="font-weight:bold;">Не упустите свой шанс стать обладателем своего авто!</span></p>
