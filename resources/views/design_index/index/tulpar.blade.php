            ...
            <div class="container" style="margin-top: 0;padding:50px 10px; color:#000;">
                <div class="row row-1 text-center">
                        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xs-12" style="margin-bottom:15px; text-align: left;">
                                ...
                                <div class="my-img-circle text-center" style="padding: 0;">
                                    ...
                                    <div class="holder" style="position: absolute;top: 2%;text-align:left;left: 10%;">
							        	<div class="texts" style="font-family: Akrobat;color: #000;position: absolute;left: 10%;top: 32%;width: 370px;font-weight: bold;">
                                            ...
                                            <p class="mb-0" style="font-size:20px;font-weight:bold;">Внеси поевые взносы ежемесячно и получи рассрочку на авто!</p>
                                       </div>
							        </div>
                                </div>
                            </div>
                            ...
                            <p>По программе<span style="font-weight:bold;"> "TULPAR"</span> Вы можете получить рассрочку уже через 6 месяцев с момента вступления в программу.</p>
                            ...
                            <p><span style="font-weight:bold;">Сумма рассрочки: до 3 000 000 KZT </span></p>
                            ...
                            <p><span style="font-weight:bold;">Вступительны взнос: 240 000 KZT </span></p>
                            <p><span style="font-weight:bold;">Первоначальный взнос: 50 000 KZT * 6 месяцев = 300 000 KZT</span></p>
                            <p><span style="font-weight:bold;">Погашение: 50 000 KZT * 54 месяцев = 2 700 000 KZT</span></p>

                            <p><span style="font-weight:bold;">Не упустите свой шанс обладателем своего авто!</span></p>
