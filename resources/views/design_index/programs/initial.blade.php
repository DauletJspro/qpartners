        ...
        <div class="mt-2">
            <div class="col-md-3 text-uppercase">
                ...
                <div class="d-flex-column pl-1 mt-1">
                    ...
                    <div class="bg-silver pl-1"><a class="my-text fs-18" href="{{ route('program.initial') }}" name="initial">с первоначальным взносом</a></div>
                    <div class="mt-1 pl-1"><a class="my-text fs-18" href="{{ route('program.share') }}" name="share">с паевым взносом</a></div>
            ...
            <div class="col-9 d-flex-column">
                ...
                <div class="d-flex-row flex-wrap pt-2">
                    ...
                    @foreach($programs as $program)
                        <div class="d-flex-column program-block-width ml-2 mt-2">
