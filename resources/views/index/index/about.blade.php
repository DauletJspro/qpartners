...
@section('meta-tags')
    ...
    <meta name="description" content="{{$about['about_name_'.$lang]}}. Qpartners - это группа единомышленников, которые уже имеют богатый опыт работы в МЛМ - индустрии, интернет-коммерции и обладают всеми необходимыми качествами для достижения поставленных целей" />
    <meta name="keywords" content="{{$about['about_name_'.$lang]}}, Qpartners, Qazaq International Holding, Qazaq Holding" />
