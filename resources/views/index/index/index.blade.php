...
@section('meta-tags')
    ...
    <meta name="keywords" content="Qpartners, Qazaq International Holding, Qazaq Holding" />
...
@section('content')
    ...
    <div id="content" class="page-wrap sidebar-left">
        <div class="main-slider">
           ...
           {{-- <div class="item-slid">
                <img src="/slider/2_2.png" alt="">
                <div class="text-slid">
                   --}}{{-- <p>“Qazaq International Holding ” стартовал на рынке Казахстана и за ее пределами с 22 марта 2017 года.</p>--}}{{--
                </div>
            </div>--}}
            <div class="item-slid">
                    ...
                    <div id="primary" class="content-area-front-page">
                        <main id="main" class="site-main" role="main">
                            <div class="entry-content">
                                ...
                                <div class="vc_row wpb_row vc_row-fluid vc_custom_1491212611528 vc_row-o-equal-height vc_row-flex"><div class="row_overlay" style=""></div>
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-4 vc_col-md-4 vc_col-has-fill"><div class="vc_column-inner vc_custom_1491212728543"><div class="wpb_wrapper"><div class="vc_empty_space"   style="height: 25px" ><span class="vc_empty_space_inner"></span></div>

                                                <div class="themesflat_counter style1  ">

                                                    <div class="counter-content-left">
                                                        <span class="counter-prefix"></span>
                                                        <span class="numb-count" data-add_zero = "0" data-from="0" data-to="{{$user_count}}" data-speed="100" data-waypoint-active="yes">{{$user_count}}</span>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-4 vc_col-md-4 vc_col-has-fill"><div class="vc_column-inner vc_custom_1491212746511"><div class="wpb_wrapper"><div class="vc_empty_space"   style="height: 25px" ><span class="vc_empty_space_inner"></span></div>

                                                <div class="themesflat_counter style1  ">

                                                    <div class="counter-content-left">
                                                        <span class="counter-prefix"></span>
                                                        <span class="numb-count" data-add_zero = "1" data-from="0" data-to="{{$user_count}}" data-speed="1000" data-waypoint-active="yes">{{$user_count}}</span>
                                                        <span class="counter-surfix"></span>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-4 vc_col-md-4 vc_col-has-fill">
                                        <div class="vc_column-inner vc_custom_1491212715920">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="themesflat_counter style1  ">
                                                    <div class="counter-content-left">
                                                        <span class="counter-prefix"></span>
                                                        <span class="numb-count" data-add_zero = "0" data-from="0" data-to="{{$user_share}}" data-speed="10" data-waypoint-active="yes">{{$user_share}}</span>
                                                        <span class="counter-surfix"></span>
                                                    </div>

                                                    <div class="counter-content-right">
                                                        <p class="title">Дольщики</p>
                                                    </div>
                                                </div>
