    ...
    <div class="container-inside">
      <div class="content-left contact-info">
        ...
        <ul>
          ...
          <li>
            <a href="mailto:qpartners.club@gmail.com" target="_top">qpartners.club@gmail.com </a>
          </li>
        </ul>
      </div><!-- /.col-md-7 -->
      ...
      <div class="content-right">
        <ul class="themesflat-socials">
          <li class="facebook">
            <a href="https://www.facebook.com/Qazaq-Turizm-863311243827972/?modal=admin_todo_tour" target="_blank" rel="alternate" title="facebook.com/themesflat">
              <i class="fa fa-facebook"></i>
            </a>
          </li>
          <li class="instagram">
            <a href="https://www.instagram.com/qpartners/" target="_blank" rel="alternate" title="#">
              <i class="fa fa-instagram"></i>
            </a>
          </li>
          <li class="vkontakte">
            <a href="https://vk.com/id461216359" target="_blank" rel="alternate" title="#">
              <i class="fa fa-vk"></i>
            </a>
          </li>
        </ul>
          ...
          <div class="header-wrap clearfix">
            <div id="logo" class="logo" >
              <a href="/"  title="Qpartners">
                <img class="logo_svg" src="/logo_main.png?v=1"  data-src="/logo_main.png?v=1" alt=""   data-retina="/logo_main.png" />
              </a>
            </div>
