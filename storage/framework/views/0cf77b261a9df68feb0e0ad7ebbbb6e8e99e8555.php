      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title box-title-first">
            <a href="/admin/news" class="menu-tab <?php if(!isset($request->active) || $request->active == '1'): ?> active-page <?php endif; ?>">Активные новости</a>
          </h3>
          <h3 class="box-title box-title-second" >
            <a href="/admin/news?active=0" class="menu-tab <?php if($request->active == '0'): ?> active-page <?php endif; ?>">Неактивные новости</a>
          </h3>
          <a href="/admin/news/create<?php if(isset($_GET['parent_id']))echo '?parent_id='.$_GET['parent_id'];?>" style="float: right">
            ...
            <tbody>
                  ...
                  <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                     ...
                     <tr>
                        ...
                        <td>
                            <a target="_blank" style="text-decoration: underline" href="/news/<?php echo e(\App\Http\Helpers::getTranslatedSlugRu($val->news_name_ru)); ?>-u<?php echo e($val->news_id); ?>">
                                <?php echo e($val['news_name_ru']); ?>
                        ...
                        <td style="text-align: center">
                            <a href="javascript:void(0)" onclick="delItem(this,'<?php echo e($val->news_id); ?>','news')">
                                <li class="fa fa-trash-o" style="font-size: 20px; color: red;"></li>
                            </a>
                        </td>
                        <td style="text-align: center">
                            <a href="/admin/news/<?php echo e($val->news_id); ?>/edit">
                                <li class="fa fa-pencil" style="font-size: 20px;"></li>
                            </a>
                        </td>
                        <td style="text-align: center;">
                            <input class="select-all" style="font-size: 15px" type="checkbox" value="<?php echo e($val->news_id); ?>"/>
                        </td>
                     </tr>
