...
<div class="form-box register-box" id="login-box">
    <div style="text-align: center">
        <a href="/">
            <img class="logo_svg" src="/logo_main.png" style="max-width: 220px; margin-bottom: 20px" />
        </a>
    </div>
    ...
    <form method="post" action="/register">
        ...
        <div class="body bg-gray">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="hidden" name="is_left_config" value="<?php if(isset($_GET['left'])): ?><?php echo e($_GET['left']); ?><?php endif; ?>"/>
                    <div class="form-group">
                        <input required type="text" name="name" value="<?php echo e($row->name); ?>" class="form-control" placeholder="Имя"/>
                    </div>
                    <div class="form-group">
                        <input required type="text" name="last_name" value="<?php echo e($row->name); ?>" class="form-control" placeholder="Фамилия"/>
                    </div>
                    <div class="form-group">
                        <input type="text" name="middle_name" value="<?php echo e($row->middle_name); ?>" class="form-control" placeholder="Отчество"/>
                    </div>
                    <div class="form-group">
                        <select required name="recommend_user_id" data-placeholder="Выберите спонсора" class="form-control selectpicker" data-live-search="true">
                            ...
                            <?php $__currentLoopData = $recommend_row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <option <?php if($row->recommend_user_id == $item->user_id || (isset($_GET['id']) && $_GET['id'] == $item->user_id) ): ?> <?php echo e('selected'); ?> <?php endif; ?> value="<?php echo e($item->user_id); ?>"><?php echo e($item['login']); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <input type="text" name="login" value="<?php echo e($row->login); ?>" class="form-control" placeholder="Логин"/>
                    </div>
                    <div class="form-group">
                        <input required type="email" name="email" class="form-control" value="<?php echo e($row->email); ?>" placeholder="Email"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <input required type="password" value="<?php echo e($row->password); ?>" name="password" class="form-control" placeholder="Пароль"/>
                    </div>
                    <div class="form-group">
                        <input required type="password" value="<?php echo e($row->confirm_password); ?>" name="confirm_password" class="form-control" placeholder="Повторите пароль"/>
                    </div>
                    <div class="form-group">
                        <input type="text" name="iin" value="<?php echo e($row->iin); ?>" class="form-control" placeholder="ИИН"/>
                    </div>
                    <div class="form-group">
                        <input required type="text" name="phone" value="<?php echo e($row->phone); ?>" class="form-control" placeholder="Телефон"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select required name="office_director_id" data-placeholder="Выберите директора офиса" class="form-control selectpicker" data-live-search="true">
                            ...
                            <?php $__currentLoopData = $office_row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <option <?php if($row->office_director_id == $item->user_id || (isset($_GET['id']) && $_GET['id'] == $item->user_id)): ?> <?php echo e('selected'); ?> <?php endif; ?> value="<?php echo e($item->user_id); ?>"><?php echo e($item['office_name']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-12 agree-label">
                    <input required  type="checkbox" value="1" id="agree_checkbox"> Регистрируясь на сайте вы подтверждаете, что ознакомлены с <a target="_blank" style="font-weight: bold" href="/file/dogovor_QT.pdf">Договором</a> и <a target="_blank" style="font-weight: bold" href="/presentation/qaz.pdf">презентацией</a>.
                </div>
            </div>
        </div>
        <div class="footer">
