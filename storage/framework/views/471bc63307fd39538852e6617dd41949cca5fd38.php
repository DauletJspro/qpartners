<?php $__env->startSection('meta-tags'); ?>
    ...
    <title>Галерея. Roiclub.kz</title>
    <meta name="description" content="Галерея. Roiclub.kz - это группа единомышленников, которые уже имеют богатый опыт работы в МЛМ - индустрии, интернет-коммерции и обладают всеми необходимыми качествами для достижения поставленных целей" />
    <meta name="keywords" content="Галерея, Roiclub.kz" />
