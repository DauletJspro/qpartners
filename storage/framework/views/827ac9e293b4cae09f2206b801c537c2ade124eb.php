<ul class="sidebar-menu">
    <li class="treeview">
        <a href="/admin/contact?active=0">
            ...
            <span class="label label-primary pull-right" id="feedback_count" style="<?php if($feedback_count == 0): ?> display: none; <?php endif; ?> background-color: rgb(253, 58, 53) ! important;"><?php echo e($feedback_count); ?></span>
        </a>
    </li>
    <li class="treeview">
        <a href="/admin/doc">
