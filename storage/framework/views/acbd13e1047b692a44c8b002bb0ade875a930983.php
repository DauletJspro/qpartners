...
<div class="form-box" id="login-box">
    <div style="text-align: center">
        <a href="/">
            <img class="logo_svg" src="/logo_main.png?v=2" style="max-width: 220px; margin-bottom: 20px" />
        </a>
    </div>
    ...
    <form method="post" action="/login">
        ...
        <div class="body bg-gray">
            ...
            <?php if(isset($is_confirm_email)): ?>
                <a style="font-weight: bold; text-decoration: underline" href="/confirm-email">Отправить код на почту повторно</a>
            <?php endif; ?>
            <div class="form-group">
                <input required type="text" name="login" value="<?php if(isset($login)): ?><?php echo e($login); ?><?php endif; ?>" class="form-control" placeholder="ID,Email или логин"/>
            </div>
            <div class="form-group">
        ...
        <div class="footer">
            <button type="submit" class="btn bg-olive btn-block" style="font-size: 17px"><?php echo e(Lang::get('app.sign_in')); ?></button>
