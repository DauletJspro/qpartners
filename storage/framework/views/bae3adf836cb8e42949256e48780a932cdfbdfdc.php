            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title box-title-first">
                        <a class="menu-tab  active-page">Подписчики аккаунтов</a>
                    </h3>
                                    ...
                                    <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="arial-font">
                                                ...
                                                <?php $val->corporative_instagram = str_replace(['https://instagram.com/','https://instagram.com','instagram.com/','instagram.com'],'',$val->corporative_instagram); ?>

                                                <div>
                                                    <a style="text-decoration: underline" href="https://www.instagram.com/<?php echo e($val->corporative_instagram); ?>" target="_blank">
                                                        <?php echo e($val->corporative_name); ?>
                                            ...
                                            <td class="arial-font">
                                                <div>
                                                    ...
                                                    <?php if($val->is_success == 0): ?>
                                                        <button onclick="acceptInstagram(this,'<?php echo e($val->user_subscribe_id); ?>')" class="btn btn-block btn-success btn-sm" style="background-color: #3C8DBC !important;">Принять</button>
                                                    <?php else: ?>
                                                        <button onclick="rejectInstagram(this,'<?php echo e($val->user_subscribe_id); ?>')" class="btn btn-block btn-success btn-sm" style="background-color: #FF0C1A !important;">Отклонить</button>
                                                    <?php endif; ?>
