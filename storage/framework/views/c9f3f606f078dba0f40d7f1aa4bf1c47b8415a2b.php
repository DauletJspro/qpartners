        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-blue">
                <div class="inner">
                    ...
                    <h3><?php echo e(round($profit,2)); ?><sup style="font-size: 20px">$</sup></h3>
                    <h2 style="margin-top: 0px"><?php echo e(round($row->currency->money * $profit,2)); ?><sup style="font-size: 20px">ТГ</sup></h2>
                    <p>Фонд компании</p>
                </div>
                <div class="icon"></div>
