<?php $__env->startSection('meta-tags'); ?>
    ...
    <meta name="description" content="«Roiclub.kz» - это уникальный медиа проект с широким набором возожностей для взаймодествия с участниками виртуального рынка" />
    <meta name="keywords" content="Roiclub.kz" />
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="content" class="page-wrap sidebar-left">
        <div class="main-slider">
            <div class="item-slid">
                <img src="/slider/1.png?v=2" alt="">
                <div class="text-slid">
                   
                </div>
            </div>
            <div class="item-slid">
                <img src="/slider/2.png?v=2" alt="">
                <div class="text-slid">
                    
                </div>
            </div>
            <div class="item-slid">
                <img src="/slider/3.png?v=2" alt="">
                <div class="text-slid">
                    
                </div>
            </div>
            <div class="item-slid">
                <img src="/slider/4.png?v=2" alt="">
                <div class="text-slid">
