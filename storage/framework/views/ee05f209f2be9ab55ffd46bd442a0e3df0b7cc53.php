                    ...
                    <table id="news_datatable" class="table table-bordered table-striped table-css">
                        ...
                        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="main-label" href="/admin/document/<?php echo e($val->user_id); ?>" target="_blank" style="text-decoration: underline">Список документов</a>
                                </td>
                                <td>
                                    <?php echo e($val->date); ?>
                                ...
                                <td style="text-align: center">
                                    <button class="btn btn-block btn-error btn-sm" onclick="deleteUserDocumentRequest(this,'<?php echo e($val->user_confirm_document_id); ?>')" style="background-color: rgb(255, 88, 83);">Удалить</button>
                                </td>
                            </tr>
